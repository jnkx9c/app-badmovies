...
<c:set var="Efirstname" value="${bindingresult.getFieldErrors('firstname')}"/>
  ...
  <form:form method="post" action="register" modelAttribute="registrationform"> 
      ...
      <div class="row">
        <div class="col">
          <div class="form-group">
            ...
            <form:input path="state" type="text" class="form-control ${bindingresult.hasFieldErrors('state')?'border border-danger':''}" placeholder="State"/>
          </div>  
        </div>
        <div class="col">
          <div class="form-group">
      ...
      <div class="row">
        ...
        <div class="col">
          <div class="form-group">
            <form:label path="password2">Retype Password</form:label>
