...
public class AppConstants {
	 ...
	 * Request parameters
	 */
	public final static String PARAM_MOVIE_ID = "movieid";
	...
	public final static String RB_PRODUCTS = "products";
	public final static String RB_SHOPPINGCART_PAGE = "shoppingcartpage";
	public final static String RB_PROCESS_ORDER = "processorder";
